...
where EmployeeID=@EmployeeID and YearMoth=@YearMonth ";
        ...
        public ReturnValue Add(Biochemistry model)
        {
            OleDbParameter[] parameters = {
					...
					new OleDbParameter("@HYTC", OleDbType.VarWChar,10),
					new OleDbParameter("@HYTG", OleDbType.VarWChar,10),
					new OleDbParameter("@HYHDLC", OleDbType.VarWChar,10),
					new OleDbParameter("@HYTBIL", OleDbType.VarWChar,10),
					new OleDbParameter("@HYDBIL", OleDbType.VarWChar,10),
					new OleDbParameter("@HYTP", OleDbType.VarWChar,10),
					new OleDbParameter("@HYALB", OleDbType.VarWChar,10),
					new OleDbParameter("@HYALT", OleDbType.VarWChar,10),
                    ...
                    new OleDbParameter("@HY_GLU", OleDbType.VarWChar,10),
