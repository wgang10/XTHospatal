...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="text-align:center;">
        <div id="DivLogin" style="text-align:center; color:#ffffff">
            ...
            <div id="DivLoginPwd" class="DivChangePWD" style="color:#ffffff">
            ...
            <div id="Div2" class="DivChangePWD" style="color:#ffffff">
            ...
            <div id="Div1" class="DivChangePWD" style="color:#ffffff">
